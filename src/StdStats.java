/** StdStats | Found on the Internet, 4/27/2015
 * This class will be used to plot the histogram for the specified Monte Carlo simulation.
 */
/*************************************************************************
...
public final class StdStats {
   ...
   /**
    ...
    public static void plotBars(double[] a) {
        ...
        StdDraw.setXscale();
        StdDraw.setYscale();
        //StdDraw.textLeft(0.01, -0.4, "0");
        //StdDraw.textRight(0.99, -0.4, N+"");
        StdDraw.textLeft(0.01, 0.1, "0");
        StdDraw.textRight(0.99, 0.1, N+"");
        StdDraw.text(0.5, 0.1, "Runtime (microseconds)");
    }
}
