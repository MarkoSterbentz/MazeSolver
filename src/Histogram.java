/** Histogram | Found on the Internet 4/28/2015
 *  This class will be used to represent a histogram of the simulation data.
 */
/*************************************************************************
...
public class Histogram {
    ...
    public void draw() {
        StdDraw.setYscale(-4, max + 1);  // to leave a little border
